...
public class ClosePollResultItemApplierTest {

	@Test
	public void apply() {
		Monitor monitor = Mockito.mock(Monitor.class);
		
		ClosePollResultItemApplier applier = new ClosePollResultItemApplier();
		applier.apply(new ClosePollResultItem(), monitor);
